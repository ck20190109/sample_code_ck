...
<head>
	...
	function load() {
		...
		fm.action = '<?php echo url('/'); ?>/lang-read/'+id.value;
		fm.submit();
	}
	function read(id) {
		fm = document.getElementById('fm_post');
		fm.action = '<?php echo url('/'); ?>/lang-read/'+id;
		fm.submit();
	}
	function save() {
        extract_save();
		...
		if (e1.value=="" || e2.value=="" || e3.value=="" || e4.value=="" || e5.value=="" || e6.value=="") {
		...
		fm = document.getElementById('fm_post');
		fm.action = '<?php echo url('/'); ?>/lang-save';
		fm.submit();
	}
	function dele(id) {
		...
		if (!y_n) return;
		fm = document.getElementById('fm_post');
		fm.action = '<?php echo url('/'); ?>/lang-delete/'+id;
		fm.submit();
	}
	function rese() {
...
<body>
    ...
    <div class="container">
		<h2 style="font-family: Raleway, sans-serif; font-weight: 600; text-transform: uppercase; color: #666; padding:10px">Notices Editor</h2>
		...
		<form id="fm_post" method="post">
			...
			<p style="padding: 0px; margin: 0px">
				<label style="width:100%" >Name:
					<input type="text" id="post_name" name="post_name" placeholder="Post Name*" value="{{ $post_name }}" style="padding: 6px 6px; border: 1px solid #c0c0c0; font-size: 14px; color: #666;" <?php echo ($post_status=='publish')?"readonly":""; ?>/>
				</label>
			</p>
			<p style="padding: 0px; margin: 0px">
			...
			<p style="padding: 0px; margin: 0px">
				<label style="width:100%" >
					<input type="hidden" id="post_type" name="post_type" placeholder="Post Type*" value="page" readonly style="padding: 6px 6px; border: 1px solid #c0c0c0; font-size: 14px; color: #666;" />
				</label>
			</p>
			<p style="padding: 0px; margin: 0px">
